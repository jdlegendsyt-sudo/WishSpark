...
const BirthdayCardMaker = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Header />
      <JsonLd data={{ "@context": "https://schema.org", "@type": "WebApplication", "name": "Birthday Card Maker Online Free", "url": "https://wishspark.xyz/tools/birthday-card-maker", "description": "Free birthday card maker online. Create beautiful birthday greeting cards with name and custom message. No signup required!", "applicationCategory": "DesignApplication", "operatingSystem": "All", "offers": { "@type": "Offer", "price": "0", "priceCurrency": "USD" }, "publisher": { "@type": "Organization", "name": "WishSpark" } }} />
